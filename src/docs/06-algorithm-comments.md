...
# 6. Примечания к алгоритму <Anchor :ids="['примечания-к-алгоритму']" />

На данной странице собраны подробные описания неочевидных моментов работы алгоритма робота.

## 6.1. Особенности использования торговых стаканов <Anchor :ids="['особенности-использования-торговых-стаканов']" />
...
## 6.2. Использование приказа переместить заявку <Anchor :ids="['использование-приказа-переместить-заявку']" />
...
## 6.3. Правила перемещения Lim_Sell и Lim_Buy <Anchor :ids="['правила-перемещения-lim_sell-и-lim_buy']" />
...
Правила перемещения сигнальных цен можно разделить на две части: произошла продажа по [Is first](05-params-description.md#_5-3-11-is-first) бумаге и произошла покупка по [Is first](05-params-description.md#_5-3-11-is-first) бумаге. Внутри каждой из этих частей алгоритм делится еще на две части: позиция портфеля до прохождения данной сделки была равна нулю и была не равна нулю.
...
## 6.4. Особенности поведения заявок, переставленных по SL или Timer <Anchor :ids="['особенности-поведения-заявок,-переставленных-по-sl-или-timer']" />
...
## 6.5. Подсчёт финансового результата <Anchor :ids="['подсчёт-финансового-результата']" />
...
## 6.6. О ценах выставления заявок второй ноги <Anchor :ids="['о-ценах-выставления-заявок-второй-ноги']" />
...
## 6.7. Об объёмах выставления заявок <Anchor :ids="['об-объёмах-выставления-заявок']" />
...
## 6.8. Участие пользователя во внутренних тестированиях, проводимых MOEX <Anchor :ids="['участие-пользователя-во-внутренних-тестированиях,-проводимых-moex']" />
...
## 6.9. Алгоритм робота в синтетических стаканах <Anchor :ids="['алгоритм-робота-в-синтетических-стаканах']" />
