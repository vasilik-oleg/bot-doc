...
# 10. API фронта 2.0 <Anchor :ids="['api-фронта-2.0']" />
<style scoped>
table {
  font-size: 13px;
}
...
## 10.1. Общие положения <Anchor :ids="['общие-положения']" />

### 10.1.1. Куда подключаться <Anchor :ids="['куда-подключаться']" />
...
### 10.1.4. Rate limits <Anchor :ids="['rate-limits']" />
...
### 10.1.5. Прочее <Anchor :ids="['прочее']" />
...
## 10.2. Авторизация <Anchor :ids="['авторизация']" />
...
## 10.3. Портфели <Anchor :ids="['портфели']" />

### 10.3.1. Подписка на список доступных портфелей <Anchor :ids="['подписка-на-список-доступных-портфелей']" />
...
### 10.3.2. Отписка от списка доступных портфелей <Anchor :ids="['отписка-от-списка-доступных-портфелей']" />
