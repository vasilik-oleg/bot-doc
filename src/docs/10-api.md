...
### 10.1.1. Подписка на список доступных портфелей
...
### 10.1.2. Отписка от списка доступных портфелей
...
### 10.1.8. “Сбросить” статусы заявок портфеля
...
### 10.1.9. Остановить торговлю и снять заявки портфеля
...
### 10.1.10. Выключить все формулы портфеля
...
### 10.1.11. “Скинуть” портфель “в рынок”
...
### 10.1.14. Выставить заявку по бумаге портфеля
...
### 10.1.15. Протестировать формулу портфеля
...
### 10.1.16. Написать на почту "создателю" порфтеля [роль: admin]
...
### 10.2.3. Подписка на робота (для админа)
...
### 10.2.4. Отписка от робота (для админа)
...
### 10.2.5. Подписка на список доступных роботов
...
### 10.2.6. Отписка от списка доступных роботов
...
### 10.2.9. Подписка на активные заявки робота
...
### 10.2.10. Отписка от активных заявок робота
...
### 10.3.1. Подписка на таблицу финансовых результатов портфеля
...
### 10.3.2. Отписка от таблицы финансовых результатов портфеля
...
### 10.3.3. Запрос истории финансовых результатов портфеля
...
### 10.3.4. Запрос истории финансовых результатов портфеля 2
...
### 10.3.5. Подсчет средних финансовых результатов портфеля за период
...
### 10.4.1. Подписка на сделки портфеля
...
### 10.4.2. Отписка от сделок портфеля
...
### 10.4.3. Запрос истории сделок портфеля
...
### 10.4.4. Запрос списка уникальных бумаг из истории сделок портфеля
...
### 10.4.5. Запрос истории сделок портфеля 2
...
### 10.5.1. Подписка на логи портфеля
...
### 10.5.2. Отписка от логов портфеля
...
### 10.5.3. Подписка на логи робота
...
### 10.5.4. Отписка от логов робота
...
### 10.5.5. Запрос истории логов робота
...
### 10.6.1. Запрос списка финансовых инструментов
...
### 10.6.2. Запрос списка клиентских кодов
...
### 10.6.3. Найти финансовый инструмент в роботе/портфеле
...
### 10.6.4. Заменить финансовый инструмент в портфелях робота
...
### 10.7.1. Подписка на маркет-дата подключения робота
...
### 10.7.2. Получить список маркет-дата подключений робота
...
### 10.7.3. Отписка от маркет-дата подключений робота
...
### 10.7.4. Операции с маркет-дата подключениями
...
### 10.7.5. Добавить/удалить бумагу в менеджер бумаг
...
### 10.7.6. Найти бумагу для менеджера бумаг
...
## 10.8. Транзакционные подключения

### 10.8.1. Добавить транзакционное подключение
...
### 10.8.2. Изменить транзакционное подключение
...
### 10.8.3. Удалить транзакционное подключение
...
### 10.8.4. Получить параметры транзакционного подключения
...
### 10.8.5. Получить бумаги, торгуемые через транзакционное подключение
...
### 10.8.6. Подписка на транзакционные подключения робота
...
### 10.8.7. Получить список транзакционных подключений робота
...
### 10.8.8. Отписка от транзакционных подключений робота
...
### 10.8.9. Подписка на активные заявки транзакционного подключения робота
...
### 10.8.10. Отписка от активных заявок транзакционного подключения робота
...
### 10.8.11. Снять активную заявку на транзакционном подключении робота
...
### 10.8.12. Подписка на позиции транзакционного подключения робота
...
### 10.8.13. Отписка от позиций транзакционного подключения робота
...
### 10.8.14. Изменить параметры позиций транзакционного подключения робота
...
### 10.8.15. Выравнять позицию по бумаге/валюте на транзакционном подключении
...
### 10.8.16. Операции с транзакционными подключениями
...
### 10.8.17. Выслать вторые части ключей транзакционных подключений
...
### 10.9.1. Запрос идентификатора шаблона объекта
...
### 10.9.2. Запрос шаблона по его идентификатору
...
### 10.9.3. Запрос шаблона нового портфеля
...
### 10.9.4. Запрос доступных sec_type
...
## 10.10. Управление роботом

### 10.10.1. Включить робота [роль: admin]
...
### 10.10.2. Выключить робота [роль: admin]
...
### 10.10.3. Перезапустить робота [роль: admin]
...
### 10.10.4. Создать робота на сервере [роль: admin]
...
### 10.10.5. Изменить робота [роль: admin]
...
### 10.10.6. Написать на почту "ответственным" пользователям робота [роль: admin]
...
### 10.10.7. Удалить робота [роль: admin]
...
### 10.10.8. Подписка на сервера [роль: admin]
...
### 10.10.9. Отписка от серверов [роль: admin]
...
### 10.10.10. Подписка на состояние модулей [роль: admin]
...
### 10.10.11. Отписка от состояния модулей [роль: admin]
...
### 10.10.12. Получить список компаний [роль: admin]
...
### 10.10.13. Получить свободный id робота [роль: admin]
...
## 10.11. Компании и пользователи

### 10.11.1. Подписка на компании [роль: admin]
...
### 10.11.2. Отписка от компаний [роль: admin]
...
### 10.11.3. Создать компанию [роль: admin]
...
### 10.11.4. Изменить компанию [роль: admin]
...
### 10.11.5. Удалить компанию [роль: admin]
...
### 10.11.6. Получить/подписка список пользователей в компаниях
...
### 10.11.7. Добавить/изменить/удалить пользователя в компании
...
### 10.11.8. Получить компании доступные пользователю
...
### 10.11.9. Получить роботов компании
...
### 10.11.10. Получить портфели компании
...
### 10.11.11. Получить портфели пользователя в компании
...
### 10.11.12. Получить емейлы пользователей компании
...
### 10.11.13. Подписка на параметры пользователя
...
### 10.11.14. Отписка от параметров пользователя
...
### 10.11.15. Изменить параметры пользователя
...
### 10.11.16. Получить отключенные настройки telegram уведомлений пользователя
...
### 10.11.17.Отключить настройки telegram уведомлений пользователя
...
## 10.12. Операции админа

### 10.12.1. Множественные операции над портфелями/подключениями робота (для админа)
...
### 10.12.2. Операции над портфелями/подключениями робота в базе данных (для админа)
...
### 10.12.3. Подписка на неотправленные email-ы
...
### 10.12.4. Отписка от неотправленных email-ов
...
### 10.12.5. Получить одноразовый ключ для логина от имени другого пользователя (для админа)
