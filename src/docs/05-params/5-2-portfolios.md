...
где `bid`, `offer`, `step` - это бид, оффер и шаг цены по [Is first 5.3.11]() бумаге, нижний индекс "0" означает текущее значение параметра, нижний индекс "1" означает новое значение параметра.  
...
Статус заявки на продажу/покупку по [Is first 5.3.11]() бумаге (не используется при выставлении заявки с помощью "кликеров").  
...
где secBid<sub>i</sub> - лучшая цена на покупку инструмента портфеля,   secOffer<sub>i</sub> - лучшая цена на продажу инструмента портфеля,   Curpos<sub>i</sub> - текущая позиция инструмента портфеля,  
Mult - [Fin res multiplier 5.3.21]() инструмента портфеля,  
