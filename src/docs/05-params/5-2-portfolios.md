...
где Curpos<sub>first</sub> и Count<sub>first</sub> - это параметры [Curpos 5.3.6.]() и [Count 5.3.8.]() для инструмента портфеля с взведенным флагом [Is first 5.3.11](), и округляется вверх или вниз в зависимости от значения параметра [n_perc_fill](https://fkviking.github.io/bot-doc/docs/05-params/5-2-portfolios.html#_5-2-11-5-n-perc-fill). Изменяется роботом, но может быть отредактирована пользователем вручную.
...
где secBid<sub>i</sub> - лучшая цена на покупку инструмента портфеля,<br> secOffer<sub>i</sub> - лучшая цена на продажу инструмента портфеля,<br> Curpos<sub>i</sub> - текущая позиция инструмента портфеля,<br>
Mult - [Fin res multiplier 5.3.21]() инструмента портфеля,<br>
