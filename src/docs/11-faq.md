...
[Sell](/docs/05-params-description.html#_5-2-39-sell-buy) стал сильно больше [Lim_Sell](/docs/05-params-description.html#_5-2-18-lim-sell-lim-buy). И при подвижке на К мы догоняли цену на бирже.
