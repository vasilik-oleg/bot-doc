...
Алерты настраиваются у каждого портфеля отдельно в соответствующем меню или пройдя по ссылке:
https://bot.fkviking.com/#p=robots&r=3::portfolios::der::notifications 
где вместо числа 3 поставьте номер своего робота (например 9902), а вместо слова `der` имя своего портфеля.
...
-**Можно ли увидеть таблицу доступности всех компонентов программы? В том числе коннекторов и базы данных программы?**
