...
### 12.1.2. Отписка от списка доступных портфелей
...
### 12.2.8. Подписка на активные заявки робота
...
### 12.2.9. Отписка от активных заявок робота
...
### 12.3.1. Подписка на таблицу финансовых результатов портфеля
...
### 12.3.2. Отписка от таблицы финансовых результатов портфеля
...
### 12.3.3. Запрос истории финансовых результатов портфеля
...
### 12.3.4. Запрос истории финансовых результатов портфеля 2
...
### 12.3.5. Подсчет средних финансовых результатов портфеля за период
...
### 12.4.1. Подписка на сделки портфеля
...
### 12.4.2. Отписка от сделок портфеля
...
### 12.4.3. Запрос истории сделок портфеля
...
### 12.4.4. Запрос списка уникальных бумаг из истории сделок портфеля
...
### 12.4.5. Запрос истории сделок портфеля 2
...
### 12.5.1. Подписка на логи портфеля
...
### 12.5.2. Отписка от логов портфеля
...
### 12.5.3. Подписка на логи робота
...
### 12.5.4. Отписка от логов робота
...
### 12.5.5. Запрос истории логов робота
...
### 12.6.1. Запрос списка финансовых инструментов
...
### 12.6.2. Запрос списка клиентских кодов
...
### 12.6.3. Найти финансовый инструмент в роботе/портфеле
...
### 12.6.4. Заменить финансовый инструмент в портфелях робота
...
### 12.7.1. Подписка на маркет-дата подключения робота
...
### 12.7.2. Получить список маркет-дата подключений робота
...
### 12.7.3. Отписка от маркет-дата подключений робота
...
### 12.7.4. Операции с маркет-дата подключениями
...
### 12.8.1. Добавить транзакционное подключение
...
### 12.8.2. Изменить транзакционное подключение
...
### 12.8.3. Удалить транзакционное подключение
...
### 12.8.4. Получить параметры транзакционного подключения
...
### 12.8.5. Получить бумаги, торгуемые через транзакционное подключение
...
### 12.8.6. Подписка на транзакционные подключения робота
...
### 12.8.7. Получить список транзакционных подключений робота
...
### 12.8.8. Отписка от транзакционных подключений робота
...
### 12.8.9. Подписка на активные заявки транзакционного подключения робота
...
### 12.8.10. Отписка от активных заявок транзакционного подключения робота
...
### 12.8.11. Снять активную заявку на транзакционном подключении робота
...
### 12.8.12. Подписка на позиции транзакционного подключения робота
...
### 12.8.13. Отписка от позиций транзакционного подключения робота
...
### 12.8.14. Изменить параметры позиций транзакционного подключения робота
...
### 12.8.15. Выравнять позицию по бумаге/валюте на транзакционном подключении
...
### 12.8.16. Операции с транзакционными подключениями
...
### 12.8.17. Выслать вторые части ключей транзакционных подключений
...
### 12.9.1. Запрос идентификатора шаблона объекта
...
### 12.9.2. Запрос шаблона по его идентификатору
...
### 12.9.3. Запрос шаблона нового портфеля
...
### 12.9.4. Запрос доступных sec_type
...
## 12.10. Управление роботом

### 12.10.1. Включить робота [роль: admin]
...
### 12.10.2. Выключить робота [роль: admin]
...
### 12.10.3. Перезапустить робота [роль: admin]
...
### 12.10.4. Создать робота на сервере [роль: admin]
...
### 12.10.5. Изменить робота [роль: admin]
...
## 12.11. Компании и пользователи

### 12.11.1. Подписка на компании [роль: admin]
...
### 12.11.2. Отписка от компаний [роль: admin]
...
### 12.11.3. Создать компанию [роль: admin]
...
### 12.11.4. Изменить компанию [роль: admin]
...
### 12.11.5. Удалить компанию [роль: admin]
...
### 12.11.6. Получить/подписка список пользователей в компаниях
...
### 12.11.7. Добавить/изменить/удалить пользователя в компании
...
### 12.11.8. Получить компании доступные пользователю
...
### 12.11.9. Получить роботов компании
...
### 12.11.10. Получить портфели компании
...
### 12.11.11. Получить портфели пользователя в компании
...
### 12.12.1. Множественные операции над портфелями/подключениями робота (для админа)
...
### 12.12.2. Операции над портфелями/подключениями робота в базе данных (для админа)
