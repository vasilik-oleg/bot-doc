...
1.⁠ ⁠Текущий день отличается от дня, в который был произведен предыдущий сдвиг. Несколько раз за один календарный день автоматическая подвижка лимитов не сработает.
