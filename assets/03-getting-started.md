...
Внимание. Если клиент из терминала или другим роботом меняется заявки, выставленные нашим роботом, то наш робот такие заявки может не отслеживать, соответствие алгоритма переставления таких заявок алгоритму робота не гарантируется.
