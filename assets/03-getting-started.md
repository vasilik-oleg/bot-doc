...
Следует понимать, что отображение на графике это не ol-line история, а некий срез данных по параметрам, по которым торгует робот. Данные поступают в среднем 3 раза в секунду и отрисовываются на графике.
