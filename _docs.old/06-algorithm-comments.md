...
Сигнальные цены [Lim_Sell](/docs/05-params-description.html#p.lim_s) и [Lim_Buy](/docs/05-params-description.html#p.lim_s) перемещаются только при прохождении сделок по [Is first](/docs/05-params-description.html#_5-3-11-is-first) инструменту портфеля кроме случая использования [Always timer](/docs/05-params-description.html#p.always_limits_timer).
...
Также перемещение сигнальных цен происходит когда заявка не может быть выставлена из-за ограничений по [v_min](/docs/05-params-description.html#p.v_min), [v_max](/docs/05-params-description.html#p.v_max), [To0](/docs/05-params-description.html#p.to0). Если робот не может купить из-за ограничений по [v_max](/docs/05-params-description.html#p.v_max), то в соответствии с параметрами портфеля [Limits timer](/docs/05-params-description.html#p.timer) и [Percent](/docs/05-params-description.html#p.percent) цены [Lim_Sell](/docs/05-params-description.html#p.lim_s) и [Lim_Buy](/docs/05-params-description.html#p.lim_b) уменьшаются на величину параметра портфеля [K](/docs/05-params-description.html#p.k), если же робот не может продать из-за ограничений по [v_min](/docs/05-params-description.html#p.v_min), то в соответствии с параметрами портфеля [Limits timer](/docs/05-params-description.html#p.timer) и [Percent](/docs/05-params-description.html#p.percent) значения [Lim_Sell](/docs/05-params-description.html#p.lim_s) и [Lim_Buy](/docs/05-params-description.html#p.lim_b) увеличиваются на величину параметра портфеля [K](/docs/05-params-description.html#p.k).
...
## **6.8. Участие пользователя во внутренних тестированиях, проводимых MOEX**
